        ...
        if centralManager == nil {
            centralManager = CBCentralManager(
                ...
                options: [
                    ...
                    CBCentralManagerOptionRestoreIdentifierKey: "com.eventemplate.central.g1",
                ]
            )
        }
...
extension G1: CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    /// restoration; requires the restore identifier passed at central
    /// creation). Adopt the peripherals so the session continues.
    nonisolated func centralManager(_: CBCentralManager, willRestoreState dict: [String: Any]) {
        ...
        DispatchQueue.main.async { [weak self] in
            ...
            for peripheral in peripherals {
                ...
                Bridge.log("G1: Restoring peripheral: \(name) (state: \(peripheral.state.rawValue))")
                ...
                if peripheral.state == .connected {
                    peripheral.discoverServices([self.UART_SERVICE_UUID])
                }
